...
// CONFIGURACIÓN DE LA PRUEBA PARA K6 
export const options = {
    ...
    thresholds: {
        ...
        // 2. Tiempo de respuesta máximo 1.5 segundos para el 95% de las peticiones
...
// LÓGICA DE USUARIO VIRTUAL
export default function () {
    // Selección de un usuario aleatorio del CSV
    ...
    check(res, {
    'respuesta fue ok': (r) => r.status === 200 || r.status === 201,
